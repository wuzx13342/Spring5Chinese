...
AppConfig workaround for this specific `method` attribute (the most common one) is to
...
* https://spring.io/blog/2016/03/20/a-geospatial-messenger-with-kotlin-spring-boot-and-postgresql[AppConfig Geospatial Messenger with Kotlin, Spring Boot and PostgreSQL]
