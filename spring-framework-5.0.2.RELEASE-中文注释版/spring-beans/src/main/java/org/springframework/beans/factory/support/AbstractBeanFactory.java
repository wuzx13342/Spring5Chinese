...
public abstract class AbstractBeanFactory extends FactoryBeanRegistrySupport implements ConfigurableBeanFactory {
	...
	public Object getBean(String name) throws BeansException {
		//doGetBean才是真正向IoC容器获取被管理Bean的过程(委派资料)
	...
	//TODO 真正实现向IOC容器获取Bean的功能，也是触发依赖注入功能的地方 真正创建bean createBean();
	protected <T> T doGetBean(final String name, @Nullable final Class<T> requiredType,
		...
		if (sharedInstance != null && args == null) {
			...
			//TODO  注意：BeanFactory是管理容器中Bean的工厂，而FactoryBean是创建创建对象的工厂Bean，两者之间有区别
			...
			try {
				...
				if (mbd.isSingleton()) {
					...
					sharedInstance = getSingleton(beanName, () -> {
						try {
							//TODO 入口 创建一个指定Bean实例对象，如果有父级继承，则合并子类和父类的定义
