...
public class AnnotationConfigApplicationContext extends GenericApplicationContext implements AnnotationConfigRegistry {
	 ...
	 */
	//TODO 最常用的构造函数，通过将涉及到的配置类传递给该构造函数，以实现将相应配置类中的Bean自动注册到容器中
	 ...
	 * @see #refresh()
	 */
	//TODO 为容器注册一个要被处理的注解Bean，新注册的Bean，必须手动调用容器的
	//TODO 可以在IOC初始化时注册也可以在IOC初始化创建之后 再注册Bean 通过refresh()方法刷新容器，触发容器对新注册的Bean的处理
